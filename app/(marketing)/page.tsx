...
export default async function IndexPage() {
  return (
    <>
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          ...
          <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
            CollectionBox allows charities to fundraise using customized
            collection boxes that can be set up by anybody and shared on social
      ...
      <section
        id="features"
        className="container mb-4 space-y-6 rounded-lg bg-slate-50 py-8 dark:bg-transparent md:py-12 lg:py-24"
      >
        ...
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Going viral</h3>
                <p className="text-sm text-muted-foreground">
                  CollectionBox is optimized for users to create content that
